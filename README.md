...
1. Open `notebooks/Train_Underwater_Model.ipynb` in [Google Colab](https://colab.research.google.com/).
2. Upload your `data/` folder as a zip file.
3. Run the training cells.
4. Download the `best.pt` file and place it in the `models/` directory.
